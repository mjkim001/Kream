...
<div class="container my">
	<div class="left_meun">
	    ...
	    <ul class="meun" style="padding-left: 0px;">	
			...
			<li class="meun item"><a href="/Kream/member/my/shopinfo/buying.jsp" style="color: black; font-weight: 700;">구매 내역</a></li>
	...
	<div class="my-home-area" style="overflow: hidden;">
		<div class="my-home">
			...
			<i class='fas fa-sort-numeric-down' id="sort-down" style='font-size:24px;'></i>
			<i class='fas fa-sort-numeric-up' id="sort-up" style='font-size:24px; display: none;'></i>

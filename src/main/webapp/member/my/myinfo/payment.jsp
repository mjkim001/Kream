...
%>
					...
					<div class="delete" style="margin: auto 0px; margin-left: auto">
						<div class="gobuying" id="insertAcc" style="padding: 5px 10px; margin-right: 20px; text-align: center;">
							<p>계좌 정보</p>
							<p>등록</p>
						</div>
					</div>
...
%>
					...
					<div class="delete" style="margin: auto 0px; margin-left: auto">
						<div class="gobuying" id="updateAcc" style="padding: 5px 10px; margin-right: 20px; text-align: center;">
							<p>계좌 정보</p>
							<p>변경</p>
						</div>
					</div>

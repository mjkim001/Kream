...
/**
 * Servlet implementation class DrbuyOrder
 */
@WebServlet("/DrbuyOrder.do")
public class DrbuyOrder extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/order/directOrder.jsp").forward(request, response);

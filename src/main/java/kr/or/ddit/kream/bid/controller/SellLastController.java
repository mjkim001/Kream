...
/**
 * Servlet implementation class SellLastController
 */
@WebServlet("/SellLastController.do")
public class SellLastController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/bid/SellLast.jsp").forward(request, response);

...
/**
 * Servlet implementation class DrSellOrder
 */
@WebServlet("/DrSellOrder.do")
public class DrSellOrder extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("가격 : " + bid_price);
		...
		request.getRequestDispatcher("/order/directSell.jsp").forward(request, response);

...
import kr.or.ddit.kream.board.service.BoardNoticeServiceImpl;
import kr.or.ddit.kream.board.service.IBoardNoticeService;
import kr.or.ddit.kream.vo.NoticeVo;

@WebServlet("/BoardNotice.do")
public class BoardNotice extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2. service객체 얻기
		IBoardNoticeService service = BoardNoticeServiceImpl.getInstance();
		...
		List<NoticeVo> list = service.selectList(map);
		for(NoticeVo v:list) {
